        ...
        >
            ...
            <ul>
                @foreach ($searchResults as $result)
                    <li class="border-b borber-gray-700">
                    <a 
                        href="{{ route('movies.show', $result['id']) }}" class="block hover:bh-gray-700 px-3 py-3 flex items-center transition ease-in-out duration-150"
